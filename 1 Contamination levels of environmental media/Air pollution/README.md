...
# Scripts are numbered accordingly (`1\_`, `2\_`, `3\_`) to make this dependency explicit. Scripts corresponding to steps 2 and 3 reuse intermediate outputs produced during step 1 and are therefore not designed to be executed independently.
