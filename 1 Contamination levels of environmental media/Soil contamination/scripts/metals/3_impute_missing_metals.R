...
communes_avant_imputation <- st_read("3 Outputs/Metaux RMQS 1km/Mediane RMQS 1km apres gestion avant imputation.sqlite")
...
write_xlsx(pourcentages_manquants[17:(nrow(pourcentages_manquants)-1),], "3 Outputs/Metaux RMQS 1km/Donnees manquantes avant imputation sans Corse.xlsx")
...
st_write(communes_apres_imputation, "3 Outputs/Metaux RMQS 1km/Mediane RMQS 1km apres gestion apres imputation.sqlite")
